...
const int version=1;//Version of the program
...
const string info[2]={"Norton Jenkins and Kodiakku", "dominantshoe@gmail.com"};//The author's contact information
...
bool settings[options];//An array used by the conf file
...
cout << "You should not see \"filename: \" appear. The script maintainer is supposed to supply the program with the argument from"
<<endl<<" a startup script. Contact the author of the script, "<<info[0]<<" at "<<info[1]<<endl;
}
...
cLineOption allCLOptions[gnus] = {clVersion, clHelp};
